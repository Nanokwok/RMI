import type { ParentNodeLabelProps, ProcessedTaskData, TaskData } from "../../../types/high-gantt-types"

export const getParentNodeLabel = ({ name, risk_name, tasks, status }: ParentNodeLabelProps): string => {
